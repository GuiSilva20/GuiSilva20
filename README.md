...
<p>
  ...
  <img src="https://img.shields.io/badge/Redis-DC382D?style=flat-square&logo=redis&logoColor=white" alt="Redis / cache">
...
## 💼 O que eu tenho entregado

Sem entrar em detalhes internos dos produtos, esse é o tipo de trabalho que faço no dia a dia:
...
Alguns repositórios abertos que dá para olhar por dentro:

- **[MyFinanceMobile](https://github.com/GuiSilva20/MyFinanceMobile)** — app mobile de gestão financeira em React Native + Expo, com formulários validados por Zod, estado global com Zustand, armazenamento seguro e gráficos.
- **[Sortify](https://github.com/GuiSilva20/Sortify)** — script para execução e benchmarking de algoritmos de ordenação sobre diferentes conjuntos de dados.
- **[Banco](https://github.com/GuiSilva20/Banco)** — projeto em Java com modelagem de operações bancárias, feito no início da minha trajetória.
...
<p align="center">
  <i>Aberto a conversar sobre novas oportunidades e colaborações.</i>
</p>
